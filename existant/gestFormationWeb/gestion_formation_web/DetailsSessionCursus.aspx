...
*/
    ...
    <asp:GridView ID="gvSessionsFormation" runat="server" AutoGenerateColumns="False" DataSourceID="odsSessionsFormation" style="float:left;" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <Columns>
            <%--            <asp:BoundField DataField="date_debut" HeaderText="Date de début" SortExpression="date_debut" />--%><%--<asp:ButtonField DataTextField="intitule" DataTextFormatString="Génerer la feuille d'éval pour {0}" HeaderText="Feuille d'éval" />--%>
            ...
            <asp:TemplateField HeaderText="Intitulé">
                <ItemTemplate>
                    ...
                    <asp:HyperLink ID="intitule" runat="server" NavigateUrl='<%# String.Format("~/DetailsSessionFormation.aspx?idSessionFormation={0}", Eval("id_session_formation")) %>' Text='<%# Eval("formation.intitule") %>'></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Feuilles d'évaluation">
                <ItemTemplate>
                    <asp:Button ID="btnGenererFeuillesEvaluation" runat="server" CommandArgument='<%# Eval("id_session_formation") %>' OnCommand="GenererFeuillesEvaluation_Command" Text='<%# Eval("formation.intitule", "Générer la FE pour {0}") %>' />
            ...
            <asp:TemplateField HeaderText="Feuilles de présence">
                <ItemTemplate>
                    <asp:Button ID="btnGenererFeuillesPresence" runat="server" CommandArgument='<%# Eval("id_session_formation") %>' OnCommand="GenererFeuillesEmargement_Command" Text='<%# Eval("formation.intitule", "Générer la FP pour {0}") %>' />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
