...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  jeu. 18 jan. 2018 à 15:30
...
-- Procédures
--
DROP PROCEDURE IF EXISTS `inscrire_session_formation`$$
...
DROP TABLE IF EXISTS `bilan_formation`;
CREATE TABLE IF NOT EXISTS `bilan_formation` (
  ...
  KEY `FK_bilan_formation_id_stagiaire` (`id_stagiaire`),
  KEY `FK_bilan_formation_id_formateur` (`id_formateur`),
  KEY `FK_bilan_formation_id_session_formation` (`id_session_formation`)
...
CREATE TABLE IF NOT EXISTS `equipement` (
  ...
  KEY `FK_equipement_id_salle` (`id_salle`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `formateur` (
  ...
  KEY `FK_formateur_id_identificateur` (`id_identificateur`),
  KEY `FK_formateur_id_societe` (`id_societe`),
  KEY `FK_formateur_id_ville` (`id_ville`)
...
DROP TABLE IF EXISTS `formateur_session_formation`;
CREATE TABLE IF NOT EXISTS `formateur_session_formation` (
  ...
  KEY `FK_formateur_session_formation_id_session_formation` (`id_session_formation`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `formateur_session_formation`
--
...
CREATE TABLE IF NOT EXISTS `formation` (
  ...
  KEY `FK_formation_id_theme` (`id_theme`)
...
DROP TABLE IF EXISTS `formation_cursus`;
CREATE TABLE IF NOT EXISTS `formation_cursus` (
  `id_cursus` int(11) NOT NULL,
  `id_formation` int(11) NOT NULL,
  `ordre` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_cursus`,`id_formation`),
  KEY `FK_formation_cursus_id_formation` (`id_formation`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `formation_cursus`
--
...
DROP TABLE IF EXISTS `identificateur`;
CREATE TABLE IF NOT EXISTS `identificateur` (
  `id_identificateur` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `session_cursus`;
CREATE TABLE IF NOT EXISTS `session_cursus` (
  `id_session_cursus` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `FK_session_cursus_id_cursus` (`id_cursus`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `session_cursus`
--
...
--
DROP TRIGGER IF EXISTS `creation_session_cursus`;
DELIMITER $$
...
CREATE TABLE IF NOT EXISTS `session_formation` (
  `id_session_formation` int(11) NOT NULL AUTO_INCREMENT,
  `date_debut` date DEFAULT NULL,
  ...
  KEY `FK_session_formation_id_formation` (`id_formation`),
  KEY `FK_session_formation_id_session_cursus` (`id_session_cursus`),
  KEY `FK_session_formation_id_salle` (`id_salle`)
...
--
DROP TRIGGER IF EXISTS `update_date_session_cursus`;
DELIMITER $$
...
CREATE TABLE IF NOT EXISTS `societe` (
  ...
  KEY `FK_societe_id_ville` (`id_ville`)
...
CREATE TABLE IF NOT EXISTS `stagiaire` (
  ...
  KEY `FK_stagiaire_id_identificateur` (`id_identificateur`),
  KEY `FK_stagiaire_id_societe` (`id_societe`)
...
DROP TABLE IF EXISTS `stagiaire_session_cursus`;
CREATE TABLE IF NOT EXISTS `stagiaire_session_cursus` (
  `id_stagiaire` int(11) NOT NULL,
  `id_session_cursus` int(11) NOT NULL,
  PRIMARY KEY (`id_stagiaire`,`id_session_cursus`),
  KEY `FK_stagiaire_session_cursus_id_session_cursus` (`id_session_cursus`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `stagiaire_session_cursus`
--
...
--
DROP TRIGGER IF EXISTS `desincription_suite_suppression`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `inscription_formation_cursus`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `inscription_formation_cursus_modif`;
DELIMITER $$
...
DROP TABLE IF EXISTS `stagiaire_session_formation`;
CREATE TABLE IF NOT EXISTS `stagiaire_session_formation` (
  `id_stagiaire` int(11) NOT NULL,
  `id_session_formation` int(11) NOT NULL,
  `tarif` decimal(15,3) DEFAULT NULL,
  PRIMARY KEY (`id_stagiaire`,`id_session_formation`),
  KEY `FK_stagiaire_session_formation_id_session_formation` (`id_session_formation`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `stagiaire_session_formation`
--
...
CREATE TABLE IF NOT EXISTS `theme` (
  ...
  KEY `FK_theme_id_categorie` (`id_categorie`)
...
DROP TABLE IF EXISTS `theme_formateur`;
CREATE TABLE IF NOT EXISTS `theme_formateur` (
  `niveau` enum('Base','Moyen','Confirmé','Expert') DEFAULT NULL,
  `id_formateur` int(11) NOT NULL,
  `id_theme` int(11) NOT NULL,
  PRIMARY KEY (`id_formateur`,`id_theme`),
  KEY `FK_theme_formateur_id_theme` (`id_theme`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
